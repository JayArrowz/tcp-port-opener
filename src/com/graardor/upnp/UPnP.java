...
public class UPnP {
    ...
    public static void start(Inet4Address address) {
    	finder = new GatewayFinder(address) {
            @Override
     ...
     */
    public static boolean openPortTCP(Inet4Address startAddress, int port) {
    	start(startAddress);
     ...
     * @return true if the operation was successful, false otherwise
     */
    public static boolean openPortUDP(Inet4Address startAddress, int port) {
    	start(startAddress);
        if(!isUPnPAvailable()) return false;
